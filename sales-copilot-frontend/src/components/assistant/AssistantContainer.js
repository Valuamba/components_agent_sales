...
const SectionDetail = ({ title, children }) => {
  ...
  function MarkdownContent({ className, markdown }) {
    ...
    return <pre className={className} dangerouslySetInnerHTML={{ __html: htmlContent }} />;
    }
      ...
      <div className="expandable-section">
        ...
        {isExpanded && (
          ...
          <div className="system-message">
            <MarkdownContent markdown={stepsDescription} className="pre-formatted" />
            </div>
          </Dropdown>
