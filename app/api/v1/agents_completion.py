...
from schemas.v1.agents_completion import AgentCompletionRequest, HandleMessagesRequest, HandleMessagesHtmlRequest
...
@agents_router.post("/agent/handle_messages/html")
def handle_messages(request: HandleMessagesHtmlRequest,
...
@agents_router.post("/agent/handle_messages/list")
